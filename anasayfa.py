...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(576, 477)
        MainWindow.setMaximumSize(QtCore.QSize(576, 477))
...
"}")
        ...
        self.label.setGeometry(QtCore.QRect(20, -56, 551, 201))
        font = QtGui.QFont()
        ...
        self.label_2.setGeometry(QtCore.QRect(25, 405, 361, 16))
        self.label_2.setObjectName("label_2")
        self.widget = QtWidgets.QWidget(self.centralwidget)
        self.widget.setGeometry(QtCore.QRect(195, 115, 351, 221))
        ...
        self.msg_2.setGeometry(QtCore.QRect(19, 117, 151, 20))
        self.msg_2.setObjectName("msg_2")
        self.msg_3 = QtWidgets.QLabel(self.centralwidget)
        self.msg_3.setGeometry(QtCore.QRect(25, 314, 141, 20))
        self.msg_3.setObjectName("msg_3")
        self.msg_4 = QtWidgets.QLabel(self.centralwidget)
        self.msg_4.setGeometry(QtCore.QRect(20, 150, 121, 16))
        self.msg_4.setObjectName("msg_4")
        self.pushButton = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton.setGeometry(QtCore.QRect(200, 350, 161, 41))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "TeknoBol WhatsApp Bot"))
        self.label_2.setText(_translate("MainWindow", "NOT: Whatsapp\'ınızın tarayıcıda açık olduğuna emin olunuz."))
        self.lineEdit.setInputMask(_translate("MainWindow", "00000000000"))
        self.msg_2.setText(_translate("MainWindow", "Gönderilecek Telefon No"))
        self.msg_3.setText(_translate("MainWindow", "Mesaj Gönderim Saati"))
        self.msg_4.setText(_translate("MainWindow", "Gönderilecek Mesaj"))
        self.pushButton.setText(_translate("MainWindow", "Mesajı Gönder"))
